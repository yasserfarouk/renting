...
class SuperAgent(DefaultParty):
    ...
    def parse_opponent_name(cls, full_opponent_name):
        ...
        # return None
        return full_opponent_name.rsplit("_", 1)[0]
    ...
    def learn(self):
        ...
        for path in self._negotiation_data_paths:
            try:
                ...
                self.logger.log(logging.INFO, "error in learn function - persistent data update, error:{}", str(e))
